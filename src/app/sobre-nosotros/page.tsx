    ...
    <div className="pt-28 pb-24 bg-brand-bg min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="brand-badge mb-3">Nuestra Esencia</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
          <div className="lg:col-span-6">
            <div className="gold-card overflow-hidden relative h-96 w-full rounded-xl shadow-soft-lg bg-gray-100">
              <Image
          ...
          <div className="lg:col-span-6 space-y-6">
            <span className="brand-badge">El Terroir Boliviano</span>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-brand-textDark">
              Altitud Extrema, Sabor Extraordinario
            </h2>
            <p className="text-base text-brand-textBody leading-relaxed">
            ...
            <p className="text-base text-brand-textBody leading-relaxed">
              En <strong className="text-brand-textDark font-bold">Altura Coffee Exports</strong>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="gold-card p-8 text-center flex flex-col items-center bg-white border border-gray-200 shadow-soft">
            <div className="w-14 h-14 rounded-full bg-brand-primaryMuted border border-brand-primary/20 flex items-center justify-center text-brand-primary mb-5">
              <ShieldCheck size={26} />
            </div>
            <h4 className="font-serif text-xl font-bold text-brand-textDark mb-2">
              Trazabilidad Total
            </h4>
        ...
        <div className="text-center flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/nuestro-cafe" className="btn-primary-solid px-8 py-3.5">
            Explorar Variedades
          </Link>
          <Link href="/contacto" className="btn-primary-outline px-8 py-3.5">
            Contactar al Equipo
          </Link>
        </div>
      </div>
