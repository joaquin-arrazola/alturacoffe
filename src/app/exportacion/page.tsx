...
import { Package, Ship, FlaskConical, CheckCircle, Phone, ArrowRight } from "lucide-react";
    ...
    <div className="pt-28 pb-24 bg-brand-dark min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="gold-badge mb-3">Comercio Internacional</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="gold-card p-8 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-lg bg-brand-gold/10 border border-brand-gold/30 flex items-center justify-center text-brand-gold mb-6">
                <Package size={24} />
              </div>
              <h3 className="font-serif text-xl font-bold text-brand-textWhite mb-3">
        ...
        <div className="gold-card p-8 sm:p-12 mb-16">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-brand-gold mb-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-serif text-lg font-bold text-brand-textWhite mb-2">
        ...
        <div className="text-center flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/cotizar" className="btn-gold-solid px-8 py-3.5">
          ...
          <a
            ...
            className="btn-gold-outline px-8 py-3.5 inline-flex items-center gap-2"
          >
            <Phone size={16} />
